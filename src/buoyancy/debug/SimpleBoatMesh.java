...
public class SimpleBoatMesh extends Mesh {
        ...
        Vector2f[] texCoords;
        int[] indices;
        private final boolean isSmoothShaded;
    ...
    private void init() {
        vertices = new Vector3f[] {
          ...
          // 30 triangles (25 without the top)
        ...
        // if not smooth, split vertices/normals before setting mesh buffers
        if(!isSmoothShaded) {
            unshareVertices();
        }
    ...
    private void unshareVertices() {
        ...
        for(int i =0; i < length; i+=3) {
            ...
            // texCoords - copy the same texCoords from the vertex that was cloned
        ...
        // overwrite existing arrays with the updated (unsmoothed) arrays
